...
export const ventasService = {
  ...
  getByDateRange: (fecha_inicio, fecha_fin) => 
    api.get(`/ventas/by-date?fecha_inicio=${fecha_inicio}&fecha_fin=${fecha_fin}`),
  getEstadisticas: (fecha_inicio, fecha_fin) =>
    api.get(`/ventas/estadisticas?fecha_inicio=${fecha_inicio}&fecha_fin=${fecha_fin}`),
...
export const alertasService = {
  getAll: (leida) => api.get(`/alertas${leida !== undefined ? `?leida=${leida}` : ''}`),
